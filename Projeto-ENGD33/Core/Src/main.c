...
#include "GY-87.h"
#include <math.h>
// Biblioteca necessária para o snprintf:
#include <stdio.h>
// FreeRTOS
#include "FreeRTOS.h"
#include "task.h"
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_Init(Corrente_Motor3_ADC1_IN8_GPIO_Port, &GPIO_InitStruct);
   ...
   /*Configure GPIO pin : Monitor_Voltagem_Bateria_Pin */
   GPIO_InitStruct.Pin = Monitor_Voltagem_Bateria_Pin;
   GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
   HAL_GPIO_Init(Monitor_Voltagem_Bateria_GPIO_Port, &GPIO_InitStruct);
   ...
   /*Configure GPIO pins : PWM_Motor3_T1_CH2N_Pin (Corrigido de CH2N para CH3N para casar com o main.h) */
   GPIO_InitStruct.Pin = PWM_Motor3_T1_CH2N_Pin;
   GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
   /*GPIO_InitStruct.Pull = GPIO_NOPULL;*/
   GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
   GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
   HAL_GPIO_Init(PWM_Motor3_T1_CH2N_GPIO_Port, &GPIO_InitStruct);
  ...
  HAL_GPIO_WritePin(GPIOB, SD_CS_Pin|Relays_Motores_Pin|NRF24_CE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SD_CS_Pin Relays_Motores_Pin */
  GPIO_InitStruct.Pin = SD_CS_Pin|Relays_Motores_Pin;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    // Corrigido: Substituído IMU_DRDY_EXTI13_Pin por IMU_DRDY_EXTI13_Pin
