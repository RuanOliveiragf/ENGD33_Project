...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = Corrente_Motor3_ADC1_IN8_Pin|Monitor_Voltagem_Bateria_ADC1_IN9_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, Corrente_Motor3_ADC1_IN8_Pin|Monitor_Voltagem_Bateria_ADC1_IN9_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = PWM_Motor1_T1_CH1N_Pin|PWM_Motor2_T1_CH2N_Pin|PWM_Motor3_T1_CH3N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
